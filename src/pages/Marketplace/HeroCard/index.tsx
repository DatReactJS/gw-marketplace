...
const HeroCard: React.FC<Props> = (props: Props) => {
  ...
  const infoProduct: InfoProfuct[] = [
    ...
    {
      img: '/assets/images/marketplace/ic-air.png',
      title: 'air',
      value: 10,
    },
    {
      img: '/assets/images/marketplace/ic-fuel.png',
      title: 'fuel',
      value: '15/80',
    },
  ];
  ...
  return (
    ...
    >
      <div className={styles.cardSpacecraft}>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.imgProduct}>
            <img alt="" src="/assets/images/marketplace/card-product.png" />
          </div>
